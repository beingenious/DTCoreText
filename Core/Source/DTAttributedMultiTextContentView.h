...
@class DTAttributedMultiTextContentView;
 ...
 */
@protocol DTAttributedMultiTextContentViewDelegate <NSObject>
 ...
 */
- (void)attributedTextContentView:(DTAttributedMultiTextContentView *)attributedTextContentView didDrawLayoutFrame:(DTCoreTextLayoutFrame *)layoutFrame inContext:(CGContextRef)context;
 ...
 */
- (BOOL)attributedTextContentView:(DTAttributedMultiTextContentView *)attributedTextContentView shouldDrawBackgroundForTextBlock:(DTTextBlock *)textBlock frame:(CGRect)frame context:(CGContextRef)context forLayoutFrame:(DTCoreTextLayoutFrame *)layoutFrame;
 ...
 */
- (UIView *)attributedTextContentView:(DTAttributedMultiTextContentView *)attributedTextContentView viewForAttachment:(DTTextAttachment *)attachment frame:(CGRect)frame;
 ...
 */
- (UIView *)attributedTextContentView:(DTAttributedMultiTextContentView *)attributedTextContentView viewForLink:(NSURL *)url identifier:(NSString *)identifier frame:(CGRect)frame;
 ...
 */
- (UIView *)attributedTextContentView:(DTAttributedMultiTextContentView *)attributedTextContentView viewForAttributedString:(NSAttributedString *)string frame:(CGRect)frame;

@end

@interface DTAttributedMultiTextContentView : UIView
{
	NSAttributedString *_attributedString;

	NSInteger _columnCount;
	NSInteger _columnGap;
...
@interface DTAttributedMultiTextContentView (Tiling)
